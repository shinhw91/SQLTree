...
insert into review values(review_seq.nextval, 'G-00001', 'M-00001', '상품평1', '상품평입니다. 최소 30자 이상 작성해주세요.', 1, '2024-01-05');
insert into review values(review_seq.nextval, 'G-00002', 'M-00001', '상품평2', '상품평입니다. 최소 30자 이상 작성해주세요.', 1, '2024-01-05');
insert into review values(review_seq.nextval, 'G-00003', 'M-00001', '상품평3', '상품평입니다. 최소 30자 이상 작성해주세요.', 2, '2024-01-05');
insert into review values(review_seq.nextval, 'G-00004', 'M-00001', '상품평4', '상품평입니다. 최소 30자 이상 작성해주세요.', 2, '2024-01-05');
insert into review values(review_seq.nextval, 'G-00005', 'M-00001', '상품평5', '상품평입니다. 최소 30자 이상 작성해주세요.', 3, '2024-01-05');
insert into review values(review_seq.nextval, 'G-00006', 'M-00002', '상품평6', '상품평입니다. 최소 30자 이상 작성해주세요.', 3, '2024-05-12');
insert into review values(review_seq.nextval, 'G-00007', 'M-00002', '상품평7', '상품평입니다. 최소 30자 이상 작성해주세요.', 4, '2024-05-12');
insert into review values(review_seq.nextval, 'G-00008', 'M-00002', '상품평8', '상품평입니다. 최소 30자 이상 작성해주세요.', 4, '2024-05-12');
...
select d.goods_code, count(d.goods_code) count, g.goods_name, g.price, g.thumb_image from detail d, goods g where d.goods_code = g.goods_code and category = '과자' group by d.goods_code, g.goods_name, g.price, g.thumb_image order by 2 desc;