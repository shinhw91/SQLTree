...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('v_comm ' || v_comm);    -- v_comm 60000 * 0.2 = 12000
    ...
    BEGIN
        ...
        DBMS_OUTPUT.PUT_LINE('v_message ' || v_message);    -- v_message eligible for commission
        DBMS_OUTPUT.PUT_LINE('v_total_comp ' || v_total_comp);        -- v_total_comp 50000 + 0 = 50000
        DBMS_OUTPUT.PUT_LINE('================================');
        v_message := 'CLERK not ' || v_message;   -- CLERK not eligible for commission
        v_comm := v_sal * .30;          -- 50000 * 0.3 = 15000
    END;
    DBMS_OUTPUT.PUT_LINE('v_sal ' || v_sal);      -- v_sal 60000
